#undef TEMPLEESCAPE_API
#undef TEMPLEESCAPE_VTABLE
...
#define UE_PROJECT_NAME TempleEscape
...
#define TEMPLEESCAPE_VTABLE DLLEXPORT_VTABLE
#define TEMPLEESCAPE_API DLLEXPORT
